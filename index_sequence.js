...
const main = async () => {
    ...
    let n = parseInt(nm[0]) || inputError('n is not correct..')
    let m = parseInt(nm[1]) || inputError('m is not correct..')
    ...
    for (let i = 0; i < m; i++) {
        ...
        let a = parseInt(ab[0]) || inputError('Class a is not correct..')
        let b = parseInt(ab[1]) || inputError('Class b is not correct..')
